...
//////// Parameter ///////////////////
error_reporting(E_ALL);		// zur Fehlersuche diese Zeile ändern in: error_reporting(E_ALL);
...
$show_ext = false;	// true: Suchergebnis mit Dateiendung anzeigen  - false: ohne Dateiendung.
