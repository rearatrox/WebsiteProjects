...
$empfaenger = "hauschild-tim@t-online.de"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Betreff"; //Betreff der Email
$placeholder = "";



$url_ok = "index.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "Impressum.html"; //Zielseite, wenn E-Mail nicht gesendet werden konnte


//Diese Felder werden nicht in der Mail stehen
$ignore_fields = array('submit', 'Email', 'Betreff', 'Vorname', 'website');
